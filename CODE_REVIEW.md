# Code Review — Decompiled DroidJack & Blackshades

The full, category-by-category code-quality teardown (this is the canonical code
review; an earlier short summary was consolidated into this document).
